      ...
      >
        {car.images.map((image: string) => (
          <Box key={image} sx={{position: 'relative', height: '100vh'}}>
            ...
            />
            <>
            <Box   sx={{position: 'absolute', display: 'flex', gap: 2, flexDirection:'column', bottom: '30%', height: 'calc(30% - 15px)', left: '5rem', width: '30vw', alignItems: 'flex-start', textAlign: 'left',}}>
